# Static Website Deployment on Amazon S3 using GitHub Actions

## Project Overview

This project demonstrates hosting a static website using Amazon S3 Static Website Hosting with automated deployment via GitHub Actions CI/CD. Whenever changes are pushed to the main branch, the website is automatically deployed to S3.
...
http://static1234.com.s3-website.ap-south-1.amazonaws.com
